...
test_fer = st.number_input("Fer (mg/L)", min_value=0.0, max_value=10.0, value=0.10)
test_nitrates = st.number_input("Nitrates (mg/L)", min_value=0.0, max_value=500.0, value=20.0)
